...
export const isLoading = actionCreator => createSelector(
...
export const wasActionDispatchedSuccessfully = actionCreator => createSelector(
  loadingReducerSelector,
  loadingReducer => {
    const data = loadingReducer[actionCreator.toString()];
...
export const getErrorMessage = actionCreator => createSelector(
  loadingReducerSelector,
